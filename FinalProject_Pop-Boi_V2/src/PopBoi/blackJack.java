...
/**
 * This class is the main panel for the game blackjack and contains all the UI
 * and game logic for the game Uses the classes hand, deck, and card
 * 
 * @author Cody Swensen
 */
public class blackJack extends JPanel {
	 ...
	 * they are split between house and player panels. House panels are always on
	 * the north side also contains the buttons needed to actually play the game
	 * 
	 * @author Cody Swensen
	 */
	...
	/**
	 * This method takes the needed card and using the image path found in the card
	 * class to create an icon that can be displayed to the user
	 * 
	 * @param card
	...
	/**
	 * This method displays the cards of the player and the house by first clearing
	 * the cards then taking what is stored in the house and repaints it every
	 * button press When displaying the dealers hand the second card will remain
	 * upside down until the the game ends
	 * 
	 * @author Cody Swensen
	 */
	...
	/**
	 * this method creates an icon for the card back to hide part of the dealers
	 * hand
	 * 
	 * @return
	 * @author Cody Swensen
	...
	/**
	 * THis method is run when the player first clicks play It creates a creates the
	 * deck and hands and adds 2 cards each
	 * 
	 * @author Cody Swensen
	 */
	...
	/**
	 * Validates the player bet and checks to see if they have enough caps to even
	 * play run before the player is given cards
	 * 
	 * @author Cody Swensen
	 */
	...
	/**
	 * When the player chooses to draw another card it adds the card and checks to
	...
	/**
	 * When the player chooses to stand the dealer will draw till they hit 17 or
	 * higher and evaluates if it wins
	 * 
	 * @author Cody Swensen
	 */
